...
export function ActivitiesPage() {
  ...
  const activities = [
    ...
    },
    {
      ...
      duration: 120,
      isCompleted: false,
      notes: "Preparación para certificación",
      color: "#8B5CF6",
    },
    {
      id: 4,
      ...
      endTime: new Date(2024, 0, 15, 14, 0),
      duration: 60,
      isCompleted: true,
      notes: "Ensalada y proteína",
      color: "#F59E0B",
    },
  ]
  ...
  const stats = {
    ...
    completionRate: Math.round((activities.filter((a) => a.isCompleted).length / activities.length) * 100),
  }
  ...
  const filters = [
    ...
    { id: "today", name: "Hoy", count: activities.length },
  ]
  ...
  const filteredActivities = activities.filter((activity) => {
    switch (selectedFilter) {
      ...
      case "completed":
        return activity.isCompleted
      case "today":
        return true // All activities are for today in this example
      default:
        return true
    }
  })
